...
public class ISEDamageTypeTagsProvider extends DamageTypeTagsProvider {
    ...
    public ISEDamageTypeTagsProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pLookupProvider, String modId, @Nullable ExistingFileHelper existingFileHelper) {
