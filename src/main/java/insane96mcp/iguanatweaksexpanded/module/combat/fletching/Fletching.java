...
public class Fletching extends Feature {
	...
	public static final RegistryObject<ITEArrowItem> QUARTZ_ARROW_ITEM = ITERegistries.ITEMS.register("quartz_arrow", () -> new ITEArrowItem(QUARTZ_ARROW::get, 1.5f, new Item.Properties()));
