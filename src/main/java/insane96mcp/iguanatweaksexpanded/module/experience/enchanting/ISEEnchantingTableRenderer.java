...
public class ISEEnchantingTableRenderer implements BlockEntityRenderer<ISEEnchantingTableBlockEntity> {
    ...
    public ISEEnchantingTableRenderer(BlockEntityRendererProvider.Context context) {
        this.bookModel = new BookModel(context.bakeLayer(ModelLayers.BOOK));
    }

    @Override
    public void render(ISEEnchantingTableBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        this.renderHoveringItem(blockEntity, ((Container) blockEntity).getItem(ISEEnchantingTableMenu.ITEM_SLOT), partialTicks, poseStack, bufferSource, packedLight);
        this.renderBook(blockEntity, ((Container) blockEntity).getItem(ISEEnchantingTableMenu.ITEM_SLOT), partialTicks, poseStack, bufferSource, packedLight, packedOverlay);
    }

    private void renderHoveringItem(ISEEnchantingTableBlockEntity blockEntity, ItemStack itemToEnchant, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    private void renderBook(ISEEnchantingTableBlockEntity blockEntity, ItemStack itemToEnchant, float partialTick, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int packedOverlay) {
        poseStack.pushPose();
