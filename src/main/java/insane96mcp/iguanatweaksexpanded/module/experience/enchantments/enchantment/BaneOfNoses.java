...
public class BaneOfNoses extends BonusDamageEnchantment {
    public static final TagKey<EntityType<?>> AFFECTED_BY_BANE_OF_NOSES = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(InsaneSE.MOD_ID, "enchantments/bane_of_noses"));
    public BaneOfNoses() {
