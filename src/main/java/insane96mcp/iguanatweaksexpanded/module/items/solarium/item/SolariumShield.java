...
public class SolariumShield extends SPShieldItem {
	...
	public float getBlockedDamage(ItemStack stack, @Nullable LivingEntity entity, Level level) {
		...
		return super.getBlockedDamage(stack, entity, level) + (3f * calculatedLightRatio);
	}
	...
	public static RegistryObject<SPShieldItem> registerShield(String id) {
		...
		RegistryObject<SPShieldItem> shield = ISERegistries.ITEMS.register(id, () -> new SolariumShield(properties));
