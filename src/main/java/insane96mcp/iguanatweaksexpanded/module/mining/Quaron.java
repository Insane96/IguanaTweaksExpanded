...
public class Quaron extends Feature {
	...
	public static final ILItemTier ITEM_TIER = new ILItemTier(2, 1942, 6f, 2.5f, 14, () -> Ingredient.of(INGOT.get()));
	...
	private static final SRArmorMaterial ARMOR_MATERIAL = new SRArmorMaterial(IguanaTweaksExpanded.RESOURCE_PREFIX + "quaron", 20, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266652_) -> {
