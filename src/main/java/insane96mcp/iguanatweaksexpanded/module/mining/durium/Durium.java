...
public class Durium extends Feature {
	...
	public static final SimpleBlockWithItem SAND_ORE = SimpleBlockWithItem.register("sand_durium_ore", () -> new FallingDropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.SAND).requiresCorrectToolForDrops().strength(1F, 1F), UniformInt.of(2, 4)));
	public static final SimpleBlockWithItem GRAVEL_ORE = SimpleBlockWithItem.register("gravel_durium_ore", () -> new FallingDropExperienceBlock(BlockBehaviour.Properties.copy(Blocks.GRAVEL).requiresCorrectToolForDrops().strength(1.2F, 1.2F), UniformInt.of(2, 4)));
