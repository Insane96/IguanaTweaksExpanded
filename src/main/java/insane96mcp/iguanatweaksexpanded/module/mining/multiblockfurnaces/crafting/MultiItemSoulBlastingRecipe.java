...
public class MultiItemSoulBlastingRecipe extends AbstractMultiItemSmeltingRecipe {
    public MultiItemSoulBlastingRecipe(ResourceLocation pId, String pGroup, ISEBookCategory pCategory, NonNullList<Ingredient> ingredients, ItemStack pResult, float outputIncrease, float pExperience, int pCookingTime, Recycle recycle) {
