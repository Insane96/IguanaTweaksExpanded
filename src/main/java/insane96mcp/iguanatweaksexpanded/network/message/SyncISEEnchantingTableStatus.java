...
public class SyncISEEnchantingTableStatus {
	BlockPos pos;
	ItemStack item;
	Map<Enchantment, Integer> knownEnchantments;

	public SyncISEEnchantingTableStatus(BlockPos pos, ItemStack itemToEnchant, Map<Enchantment, Integer> knownEnchantments) {
		this.pos = pos;
		this.item = itemToEnchant;
		this.knownEnchantments = knownEnchantments;
	}

	public static void encode(SyncISEEnchantingTableStatus pkt, FriendlyByteBuf buf) {
	...
	public static SyncISEEnchantingTableStatus decode(FriendlyByteBuf buf) {
		...
		return new SyncISEEnchantingTableStatus(pos, stack, knownEnchantments);
	}

	public static void handle(final SyncISEEnchantingTableStatus message, Supplier<NetworkEvent.Context> ctx) {
		ctx.get().enqueueWork(() -> {
			if (!(Minecraft.getInstance().level.getBlockEntity(message.pos) instanceof ISEEnchantingTableBlockEntity blockEntity))
				return;
